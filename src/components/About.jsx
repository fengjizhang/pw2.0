...
const About = (props) => {
    ...
    return (
        <div className="about">
            ...
            <div className='three'>I am a full-stack engineer majoring in Electrical and Computer Engineering at Ohio State University. I am graduating in Spring 2024.
                 ...
                 independent teamworker, strong in picking up things quickly. </div><br></br>
            <div className='pands'>
                ...
                <div >
                    ...
                    <div className='skillsSection'>
                        <div className='category'>Front-End: <span className='skills5'>NextJS, React, HTML5, CSS3, Redux, Authentication, ExpressJS</span></div>
                        <div className='category'>Back-End: <span className='skills5'>Node.js, PostgreSQL, MongoDB, MySQL, RESTful API Development</span></div>
                        ...
                        <div className='category'>Engineering: <span className='skills5'>Matlab, Solidworks</span></div>
                        <div className='category'>Programming Languages: <span className='skills5'>JavaScript(ES5 and ES6)/TypeScript, Java, C, C++, Matlab</span></div>
                    </div>
                </div>
